...
class MainFrame(wx.Frame): 
    ...
    def OnZoom(self, e):
        text='Zoom'
        callback='zoom'
        dis=( ('Pan','OnMove') ,(None,None))
	self.SetButtonStatus(e,text, callback, disable=dis)
        e.Skip()
    ...
    def OnSnap(self, e):
        text='Snap'
        callback='OnSnap'
        dis=(('LineTool','OnLineTool'),(None,None))
	self.SetButtonStatus(e,text, callback, disable=dis)
        e.Skip()
    ...
    def OnBinding(self, e):
        text='Binding'
        callback='OnBinding'
        dis=(('Stability','OnStability'),('Reaction','OnReaction'))
	self.SetButtonStatus(e,text, callback, disable=dis)
        e.Skip()
    ...
    def OnStability(self, e):
        ...
        dis=(('Binding','OnBinding'),('Reaction','OnReaction'))
	self.SetButtonStatus(e,text, callback, disable=dis)
        e.Skip()
    ...
    def OnReaction(self, e):
        text='Reaction'
        callback='OnReaction'
        dis=(('Binding','OnBinding'),('Stability','OnStability'))
	self.SetButtonStatus(e,text, callback, disable=dis)
        e.Skip()
    ...
    # On Toggle3D
    # -------------------------------------------------------------------------
    def SetButtonStatus( self, e, text, callback, disable=None ):
        #       
        # use callback of MPL toolbar
        #       
        current_page = self.A.NoteBook.GetSelection()
...
if __name__ == '__main__':
    ...
    ReadWriteCfgFile()
    frame = MainFrame(None, 'Ternay Phase Diagram Analyzer')
